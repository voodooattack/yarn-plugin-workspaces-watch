/* eslint-disable */
module.exports = {
name: "@yarnpkg/plugin-workspaces-watch",
...
/* harmony import */ var clipanion__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(2);
...
/* harmony import */ var _yarnpkg_core_lib_structUtils__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(9);
/* harmony import */ var split_cmd__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(4);
/* harmony import */ var split_cmd__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(split_cmd__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var process__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(5);
...
/* harmony import */ var _yarnpkg_fslib_lib_path__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(6);
...
function getManifestPath(ws, fileName = _yarnpkg_fslib__WEBPACK_IMPORTED_MODULE_2__.Filename.manifest) {
  return _yarnpkg_fslib__WEBPACK_IMPORTED_MODULE_2__.ppath.join(ws.cwd, fileName);
}

class WorkspacesWatch extends clipanion__WEBPACK_IMPORTED_MODULE_1__.Command {
  constructor() {
    super(...arguments);
    this.proxied = [];
  ...
  execute() {
    if (this.pidFile) {
      const p = (0,_yarnpkg_fslib_lib_path__WEBPACK_IMPORTED_MODULE_5__.convertPath)(_yarnpkg_fslib__WEBPACK_IMPORTED_MODULE_2__.ppath, this.pidFile);

      if (_yarnpkg_fslib__WEBPACK_IMPORTED_MODULE_2__.xfs.existsSync(p)) {
        throw new Error(`A workspaces watch is already running. PID file ${p} already exists.`);
      }

      _yarnpkg_fslib__WEBPACK_IMPORTED_MODULE_2__.xfs.writeFileSync(p, process__WEBPACK_IMPORTED_MODULE_4__.pid.toString());
    }

    if (this.json) this.proxied.push("--json");
    if (this.inlineBuilds) this.proxied.push("--inline-builds");
    if (this.skipBuilds) this.proxied.push("--skip-builds");
    this.setupSignals();
    return this.start();
  }
  ...
  setupSignals() {
    ...
    const handleSignal = signal => {
      ...
      exiting = true;
      this.clearWatches();
      if (this.report) this.report.reportInfo(_yarnpkg_core__WEBPACK_IMPORTED_MODULE_0__.MessageName.UNNAMED, `Received ${signal}, exiting gracefully.`);
      if (this.pidFile) _yarnpkg_fslib__WEBPACK_IMPORTED_MODULE_2__.xfs.unlinkSync((0,_yarnpkg_fslib_lib_path__WEBPACK_IMPORTED_MODULE_5__.convertPath)(_yarnpkg_fslib__WEBPACK_IMPORTED_MODULE_2__.ppath, this.pidFile));
      process__WEBPACK_IMPORTED_MODULE_4__.exit(0);
    };

    process__WEBPACK_IMPORTED_MODULE_4__.on("SIGTERM", handleSignal);
    process__WEBPACK_IMPORTED_MODULE_4__.on("SIGINT", handleSignal);
  }

  runInstall(workspace) {
    return _yarnpkg_fslib__WEBPACK_IMPORTED_MODULE_2__.xfs.lockPromise(getManifestPath(workspace.project.topLevelWorkspace, _yarnpkg_fslib__WEBPACK_IMPORTED_MODULE_2__.Filename.lockfile), async () => {
      await this.cli.run(["workspace", (0,_yarnpkg_core_lib_structUtils__WEBPACK_IMPORTED_MODULE_6__.stringifyIdent)(workspace.manifest.name), "install", ...this.proxied], this.context);
    }).then(async () => {
      if (this.exec) await this.cli.run(["workspace", (0,_yarnpkg_core_lib_structUtils__WEBPACK_IMPORTED_MODULE_6__.stringifyIdent)(workspace.manifest.name), "exec", ...(0,split_cmd__WEBPACK_IMPORTED_MODULE_3__.split)(this.exec)]);
    }).catch(e => {
      this.report.reportError(_yarnpkg_core__WEBPACK_IMPORTED_MODULE_0__.MessageName.EXCEPTION, e.message);
    });
  }

  async onWatch(workspace, manifestPath, eventType, filename) {
    const watchEntry = this.watchList.get(manifestPath);
    if (!watchEntry) return;

    if (!_yarnpkg_fslib__WEBPACK_IMPORTED_MODULE_2__.xfs.existsSync(manifestPath)) {
      watchEntry.watcher.close();
      this.watchList.delete(manifestPath);
      this.report.reportInfo(_yarnpkg_core__WEBPACK_IMPORTED_MODULE_0__.MessageName.UNNAMED, `Workspace closed: ${manifestPath}`);
      return;
    }

    if (watchEntry.timeout) clearTimeout(watchEntry.timeout);else this.report.reportInfo(_yarnpkg_core__WEBPACK_IMPORTED_MODULE_0__.MessageName.UNNAMED, `Workspace changed ${workspace.cwd}`);
    watchEntry.timeout = setTimeout(() => {
      this.runInstall(workspace).finally(() => {
        this.report.reportInfo(_yarnpkg_core__WEBPACK_IMPORTED_MODULE_0__.MessageName.UNNAMED, `Workspace updated ${workspace.cwd}`);
        watchEntry.timeout = null;
      });
    }, 300);
  }

  createWatchCallback(workspace, manifestPath) {
    return (eventType, filename) => this.onWatch(workspace, manifestPath, eventType, filename);
  }

  addWorkspace(workspace) {
    const manifestPath = getManifestPath(workspace);
    this.report.reportInfo(_yarnpkg_core__WEBPACK_IMPORTED_MODULE_0__.MessageName.UNNAMED, `Watching workspace: ${(0,_yarnpkg_core_lib_structUtils__WEBPACK_IMPORTED_MODULE_6__.stringifyIdent)(workspace.manifest.name)}`);
    const watcher = _yarnpkg_fslib__WEBPACK_IMPORTED_MODULE_2__.xfs.watch(manifestPath, this.createWatchCallback(workspace, manifestPath));
    this.watchList.set(manifestPath, {
      workspace,
      watcher,
      timeout: null
    });
  ...
  async addProject(project, configuration) {
    this.clearWatches();
    await this.runInstall(project.topLevelWorkspace);

    for (const ws of project.workspaces) {
      const manifestPath = _yarnpkg_fslib__WEBPACK_IMPORTED_MODULE_2__.ppath.join(ws.cwd, _yarnpkg_core__WEBPACK_IMPORTED_MODULE_0__.Manifest.fileName);
  ...
  async start() {
    ...
    const {
      project
    } = await _yarnpkg_core__WEBPACK_IMPORTED_MODULE_0__.Project.find(configuration, this.context.cwd);
    await _yarnpkg_core__WEBPACK_IMPORTED_MODULE_0__.StreamReport.start({
      ...
      this.report = report;
      report.reportInfo(_yarnpkg_core__WEBPACK_IMPORTED_MODULE_0__.MessageName.UNNAMED, `Starting in watch mode: ${(0,_yarnpkg_core_lib_structUtils__WEBPACK_IMPORTED_MODULE_6__.stringifyIdent)(project.topLevelWorkspace.manifest.name)}`);
...
WorkspacesWatch.usage = clipanion__WEBPACK_IMPORTED_MODULE_1__.Command.Usage({
  category: `Workspace-related commands`,
  description: `Watch for changes in all workspaces. Installing, updating, and removing packages on demand`,
  details: `
      This command is similar to \`yarn install\`, but it doesn't exit and keeps watching for any changes to ${_yarnpkg_core__WEBPACK_IMPORTED_MODULE_0__.Manifest.fileName} files, updating project dependencies as necessary.
    `,
  examples: [[`Watch all workspaces`, `$0 workspaces watch`], [`Run a command after every update in the affect workspace's directory`, `$0 workspaces watch --exec "echo Hello world!"`]]
});

(0,tslib__WEBPACK_IMPORTED_MODULE_7__.__decorate)([clipanion__WEBPACK_IMPORTED_MODULE_1__.Command.Boolean("--json", {
  description: "Format the output as an NDJSON stream"
})], WorkspacesWatch.prototype, "json", void 0);

(0,tslib__WEBPACK_IMPORTED_MODULE_7__.__decorate)([clipanion__WEBPACK_IMPORTED_MODULE_1__.Command.Boolean("--inline-builds", {
  description: "Verbosely print the output of the build steps of dependencies"
})], WorkspacesWatch.prototype, "inlineBuilds", void 0);

(0,tslib__WEBPACK_IMPORTED_MODULE_7__.__decorate)([clipanion__WEBPACK_IMPORTED_MODULE_1__.Command.Boolean("--skip-builds", {
  description: "Skip the build step altogether"
})], WorkspacesWatch.prototype, "skipBuilds", void 0);

(0,tslib__WEBPACK_IMPORTED_MODULE_7__.__decorate)([clipanion__WEBPACK_IMPORTED_MODULE_1__.Command.String("--exec", {
  description: "Command to execute on update"
})], WorkspacesWatch.prototype, "exec", void 0);

(0,tslib__WEBPACK_IMPORTED_MODULE_7__.__decorate)([clipanion__WEBPACK_IMPORTED_MODULE_1__.Command.String("--pid-file", {
  description: "PID file to use"
})], WorkspacesWatch.prototype, "pidFile", void 0);

(0,tslib__WEBPACK_IMPORTED_MODULE_7__.__decorate)([clipanion__WEBPACK_IMPORTED_MODULE_1__.Command.Path("workspaces", "watch")], WorkspacesWatch.prototype, "execute", null);

const WatchPluginDesc = {
  commands: [WorkspacesWatch]
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (WatchPluginDesc);
...
const querystring_1 = tslib_1.__importDefault(__webpack_require__(10));
const semver_1 = tslib_1.__importDefault(__webpack_require__(11));
const formatUtils = tslib_1.__importStar(__webpack_require__(12));
const hashUtils = tslib_1.__importStar(__webpack_require__(48));
const miscUtils = tslib_1.__importStar(__webpack_require__(26));
const structUtils = tslib_1.__importStar(__webpack_require__(9));
...
const tslib_1 = __webpack_require__(7);
const fslib_1 = __webpack_require__(3);
const chalk_1 = tslib_1.__importDefault(__webpack_require__(13));
const MessageName_1 = __webpack_require__(25);
const miscUtils = tslib_1.__importStar(__webpack_require__(26));
const structUtils = tslib_1.__importStar(__webpack_require__(9));
...
const {stdout: stdoutColor, stderr: stderrColor} = __webpack_require__(19);
const {
	stringReplaceAll,
...
const makeDynamicStyles = (wrap, targetSpace, identity, isBackground) => {
	if (colorConvert === undefined) {
		colorConvert = __webpack_require__(15);
	}
...
const conversions = __webpack_require__(16);
...
const tty = __webpack_require__(21);
...
const micromatch_1 = tslib_1.__importDefault(__webpack_require__(27));
...
function dynamicRequire(path) {
    ...
    if (typeof require !== `undefined`) {
        ...
        return __webpack_require__(46)(path);
    }
}
...
const picomatch = __webpack_require__(39);
...
const stringify = __webpack_require__(30);
const compile = __webpack_require__(32);
const expand = __webpack_require__(36);
...
const fill = __webpack_require__(33);
const utils = __webpack_require__(31);
...
const util = __webpack_require__(28);
const toRegexRange = __webpack_require__(34);
...
const isNumber = __webpack_require__(35);
...
const globby_1 = tslib_1.__importDefault(__webpack_require__(50));
...
const arrayUnion = __webpack_require__(52);
const merge2 = __webpack_require__(53);
const fastGlob = __webpack_require__(54);
const dirGlob = __webpack_require__(108);
const gitignore = __webpack_require__(110);
const {FilterStream, UniqueStream} = __webpack_require__(113);
...
const taskManager = __webpack_require__(55);
const async_1 = __webpack_require__(67);
const stream_1 = __webpack_require__(104);
...
const array = __webpack_require__(57);
exports.array = array;
const errno = __webpack_require__(58);
exports.errno = errno;
const fs = __webpack_require__(59);
exports.fs = fs;
const path = __webpack_require__(60);
exports.path = path;
const pattern = __webpack_require__(61);
exports.pattern = pattern;
const stream = __webpack_require__(65);
exports.stream = stream;
const string = __webpack_require__(66);
...
const path = __webpack_require__(8);
const globParent = __webpack_require__(62);
const micromatch = __webpack_require__(27);
const picomatch = __webpack_require__(39);
const GLOBSTAR = '**';
const ESCAPE_SYMBOL = '\\';
...
var isGlob = __webpack_require__(63);
var pathPosixDirname = __webpack_require__(8).posix.dirname;
var isWin32 = __webpack_require__(20).platform() === 'win32';
...
var isExtglob = __webpack_require__(64);
var chars = { '{': '}', '(': ')', '[': ']'};
var strictRegex = /\\(.)|(^!|\*|[\].+)]\?|\[[^\\\]]+\]|\{[^\\}]+\}|\(\?[:!=][^\\)]+\)|\([^|]+\|[^\\)]+\))/;
var relaxedRegex = /\\(.)|(^!|[*?{}()[\]]|\(\?)/;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const stream_1 = __webpack_require__(68);
const provider_1 = __webpack_require__(97);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const stream_1 = __webpack_require__(45);
const fsStat = __webpack_require__(69);
const fsWalk = __webpack_require__(74);
const reader_1 = __webpack_require__(96);
...
const async = __webpack_require__(70);
const sync = __webpack_require__(71);
const settings_1 = __webpack_require__(72);
...
const stream_1 = __webpack_require__(92);
const sync_1 = __webpack_require__(93);
const settings_1 = __webpack_require__(95);
exports.Settings = settings_1.default;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const async_1 = __webpack_require__(76);
class AsyncProvider {
...
const fsScandir = __webpack_require__(78);
const fastq = __webpack_require__(88);
const common = __webpack_require__(90);
const reader_1 = __webpack_require__(91);
...
const async = __webpack_require__(79);
const sync = __webpack_require__(85);
const settings_1 = __webpack_require__(86);
exports.Settings = settings_1.default;
...
const fsStat = __webpack_require__(69);
const rpl = __webpack_require__(80);
const constants_1 = __webpack_require__(81);
const utils = __webpack_require__(82);
...
var reusify = __webpack_require__(89)
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const sync_1 = __webpack_require__(94);
class SyncProvider {
    constructor(_root, _settings) {
        this._root = _root;
        this._settings = _settings;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const path = __webpack_require__(8);
const deep_1 = __webpack_require__(98);
const entry_1 = __webpack_require__(101);
const error_1 = __webpack_require__(102);
const entry_2 = __webpack_require__(103);
class Provider {
    constructor(_settings) {
        this._settings = _settings;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const utils = __webpack_require__(56);
const partial_1 = __webpack_require__(99);
class DeepFilter {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const matcher_1 = __webpack_require__(100);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const stream_1 = __webpack_require__(45);
const stream_2 = __webpack_require__(68);
const provider_1 = __webpack_require__(97);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
const sync_1 = __webpack_require__(106);
const provider_1 = __webpack_require__(97);
...
const path = __webpack_require__(8);
const pathType = __webpack_require__(109);
...
const path = __webpack_require__(8);
const fastGlob = __webpack_require__(54);
const gitIgnore = __webpack_require__(111);
const slash = __webpack_require__(112);
